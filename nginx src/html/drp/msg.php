<?php	
	...
	msg_send($message_queue, 1, $_POST["listen_port"],false,false,$error);	

	msg_send($message_queue, 1, $_POST["server_name"],false,false,$error);
...
<body style="text-align:center">
	<p class="text-error lead"> Conf Information has been updated!</p>
</body>
